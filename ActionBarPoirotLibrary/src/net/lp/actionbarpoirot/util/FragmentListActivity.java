 ...
 * 
 * @note This is a merge from a ListActvity with FragmentActivity. Changes from ListActivity versus Activity are mapped onto FragmentActivity.
 * @note When ListActivity updates, I need to verify that I copy over the changes.
 * @author pjv
 * 
 */
