 ...
 * @hide
 */
@TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH) public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    /**
     * The label for the main action for the expand activities action button;
     */
	private TextView mMainActionLabel;
     ...
     */
    CustomActionProvider mProvider;
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(R.layout.activity_chooser_view, this);
        ...
        mAllowTextWithIcon = context.getResources().getBoolean(
                R.bool.config_allowActionMenuItemTextWithIcon);

        mMainActionLabel = (TextView) findViewById(R.id.main_action_label);
        updateMainLabelVisibility();
	...
	protected void updateMainLabelVisibility() {
		mMainActionLabel.setVisibility(mAllowTextWithIcon ? VISIBLE : GONE);
	}
     ...
     */
    public void setProvider(CustomActionProvider provider) {
        mProvider = provider;
    }
    ...
    private void updateAppearance() {
        ...
        if (activityCount==1 || activityCount > 1 && historySize > 0) {
            ...
            //Collectionista
            // Set the icon, but not the logo (activity icon), but the intent filter icon
            mDefaultActivityButtonImage.setImageResource(activity.getIconResource());
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (itemViewType) {
                ...
                case ITEM_VIEW_TYPE_ACTIVITY:
                    ...
                    iconView.setImageResource(activity.getIconResource());
	...
	public void setMainLabel(String label) {
		mMainActionLabel.setText(label);
	}
}
