...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    public ActionBar(Context context, AttributeSet attrs) {
        ...
        mBarView = (RelativeLayout) mInflater.inflate(R.layout.actionbar, null);//Should be null. Noticed by pjv. See http://www.doubleencore.com/2013/05/layout-inflation-as-intended/.
        addView(mBarView);
